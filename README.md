...
| Версия | Описание | Поддерживаемые платформы<br/>(минимальная версия) | Нововведения |
| :--: | -- | -- | -- |
...
| 2 | [Кроссплатформенное мультидисциплинарное электронное учебное пособие "Оприс" версии 2](#v2) | &#9989;**Android** 5.0 (API 21)<br/>**iOS** 11<br/>&#9989;**Windows** 10 (с помощью **Win UI 3**)<br/>**macOS** 10.15 | .NET MAUI |
...
## Публикации и работы ##
| № | Название работы | Название мероприятия и ссылка | Год и место проведения |
| :--: | -- | -- | -- |
