...
| 4 (текущая)<br>(студенческая) | **Цифровая образовательная платформа "Оприс" для изучения математики и программирования** | &#9989;Windows <br/> Android <br/> iOS <br/> macOS <br/> Linux (Ubuntu) | Были разделены студенческая и преподавательская версии. Студенческая версия стала значительно быстрее |
...
<img src="Акт о внедрении.png" alt="Акт о внедрении в АПИ" height="800">
...
![видеодемонстрация версии 2](Test/видео1.gif)  
...
![видеодемонстрация версии 1](Test/видео.gif)  
#### Windows
...
![a9](Version%20History/v0-WinForms.png)
