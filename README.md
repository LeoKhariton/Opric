...
| :--: | -- | -- | -- |
| 0 | [Электронное учебное пособие по программированию на C++](https://github.com/LeoKhariton/Opric?tab=readme-ov-file#версия-0--электронное-учебное-пособие-по-программированию-на-c) | Windows 7 | &#10060; |
