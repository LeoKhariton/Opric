...
| 3 [только preview](https://github.com/LeoKhariton/Opric/releases/tag/v3.0-preview2) | **Android** 5.0 (API 21)<br/>**iOS** 11<br/>&#9989;**Windows** 10 (с помощью **Win UI 3**)<br/>**macOS** 10.15 |
### Android
