...
### Версия 3 &ndash; Мультидисциплинарное кроссплатформенное электронное учебное пособие "Оприс" с функциями администрирования (только preview)
Приложение было с множеством нововведений, но релиз так и не состоялся.  

### Версия 2 &ndash; Кроссплатформенное электронное учебное пособие по программированию на C++ "Оприс"
