...
## Аннотация
Это &ndash; мультидисциплинарное кроссплатформенное электронное учебное пособие (ЭУП).  
В приложении:
- собраны лекции, практические задания и тесты самопроверки (на настоящий момент доступны дисциплины "Программирование на языке С/С++" и "Численные методы";  
